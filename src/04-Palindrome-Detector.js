...
readline.question(`Check for a Palindrome: `, searchString => {
    ...
    if (letterList.join("") == searchString.toLowerCase()) {
        ...
        console.log("\x1b[31m", `IS NOT A PALINDROME`);
    };

    // Blank line / reset colors:
    console.log("\x1b[0m", "");

    // Summon the dark magic of the Dark Faeries and bring down the Wold under their command and destroy the
    // Universe with the power of human souls:
    exit();
